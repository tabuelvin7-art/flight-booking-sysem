  ...
  const tabs = [
    {
      ...
      content: (
        <div>
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">Recent Bookings</h2>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-sm sm:text-base text-gray-600">Here's what's happening with your flights</p>
      </div>
